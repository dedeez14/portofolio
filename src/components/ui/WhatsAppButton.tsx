...
export function WhatsAppButton() {
    ...
    const handleWhatsAppClick = () => {
        const message = encodeURIComponent(
            "Halo DedeProjectDev! 👋\n\nSaya tertarik dengan jasa pembuatan website Anda. Bisa konsultasi gratis?\n\nTerima kasih! 😊"
        );
        window.open(`https://wa.me/6283898911244?text=${message}`, '_blank');
    };
            ...
            {isVisible && (
                ...
                >
                    <motion.button
                        ...
                        className="group bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 relative"
